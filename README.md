...
```bash
$ git clone https://github.com/Solana Pizza-labs/Solana Pizza.git
$ cd Solana Pizza
```
...
Start your own testnet locally, instructions are in the [online docs](https://docs.Solana Pizza.com/cluster/bench-tps).

### Accessing the remote development cluster

- `devnet` - stable public cluster for development accessible via
  devnet.Solana Pizza.com. Runs 24/7. Learn more about the [public clusters](https://docs.Solana Pizza.com/clusters)
